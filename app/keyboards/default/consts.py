...
POSSIBLE_INPUT_ACTIONS_TYPES = (
    str | dict[str, POSSIBLE_BUTTON_PROPERTIES_VALUES]
)
...
class DefaultConstructor:
    ...
    max_possible_properties = (
        len(required_properties) + max_additional_properties
    )
    ...
    def _create_kb(
        ...
        for i in actions:
            ...
            if isinstance(i, str):
                ...
                cur_action: dict[str, POSSIBLE_BUTTON_PROPERTIES_VALUES] = {
                    **i,
                }
                data = {}
                ...
                for cur_action_k, cur_action_v in cur_action.items():
                    if (
                        cur_action_k
                        not in DefaultConstructor.possible_properties
                    ):
                    ...
                    if (
                        len(data)
                        >= DefaultConstructor.max_possible_properties
                    ):
